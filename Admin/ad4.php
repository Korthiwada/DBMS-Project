...
$result = mysqli_query($conn,$sql);
 $num_rows = mysqli_num_rows($result);
  ...
  {
   echo " 
    <form action='http://localhost/payroll/Admin/ad41.php' method='post'>
  <fieldset>
...
echo "	
     <form action='http://localhost/payroll/Admin/ad4.php' method = 'post'>
  <fieldset>
    <legend style = 'color:white;font-size:160%;'>Employee id</legend>
    Employee_Id: <br> 			  
...
<br>
  ...
  <br><br><br>
  <div class ='wrapper row2'>
  <form action='http://localhost/payroll/Admin/ad42.php' method = 'post'>
  <fieldset>
